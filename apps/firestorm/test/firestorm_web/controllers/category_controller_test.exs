defmodule FirestormWeb.CategoryControllerTest do
  ...
  @create_attrs %{inserted_at: ~N[2010-04-17 14:00:00], slug: "some slug", title: "some title", updated_at: ~N[2010-04-17 14:00:00]}
  ...
  def fixture(:category) do
    {:ok, category} = FirestormAdmin.create_category(@create_attrs)
    category
  end
